    ...
    <div className="min-h-screen bg-white text-slate-900 py-12 px-6">
      <div className="max-w-3xl mx-auto space-y-12">
        ...
        <header className="space-y-4">
          <h1 className="text-4xl font-bold tracking-tight text-black">Privacy Policy</h1>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-black">3. How We Use Information</h2>
          <p className="leading-relaxed">
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-black">4. Google AdSense and Third Party Advertising</h2>
          <div className="space-y-4 leading-relaxed">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Users can opt out of personalized advertising by visiting <a href="https://www.google.com/settings/ads" className="text-blue-600 underline" target="_blank" rel="noopener noreferrer">Google Ads Settings</a>.</li>
            </ul>
            <p>
              For more information on how Google uses data when you use our site, please visit <a href="https://policies.google.com/privacy" className="text-blue-600 underline" target="_blank" rel="noopener noreferrer">Google's Privacy & Terms</a>.
            </p>
          </div>
          <Separator className="bg-slate-200" />
        </section>
        ...
        {/* 5. Cookies */}
        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-black">5. Cookies</h2>
          <p className="leading-relaxed">
        ...
        {/* 6. Local Storage */}
        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-black">6. Local Storage</h2>
          <p className="leading-relaxed">
        ...
        {/* 7. Third Party Links */}
        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-black">7. Third Party Links</h2>
          <p className="leading-relaxed">
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-black">9. Changes to This Policy</h2>
          <p className="leading-relaxed">
