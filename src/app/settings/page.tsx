  ...
  return (
    <div className="max-w-3xl mx-auto space-y-12 py-12 px-6">
      ...
      >
        <Badge
          variant="outline"
          className="px-4 py-1 border-primary/30 text-primary bg-primary/5 uppercase tracking-tighter font-bold select-none"
        >
          App Settings
        </Badge>
      ...
      <section
        ref={notifRef}
        className={cn(
          "space-y-8 transition-all pb-12",
      ...
      >
        <div className="space-y-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="text-xl font-bold select-none">Alert Triggers</h3>
          </div>
      ...
      <div className="space-y-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="text-xl font-bold select-none">Audio & Haptics</h3>
          </div>
          <div className="bg-card/30 p-6 rounded-2xl border border-border/50 space-y-4">
            ...
            {settings.soundEnabled && (
              <div className="pt-4 space-y-4">
                <label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground select-none">
                  Select Ringtone
                </label>
                <div className="flex gap-2">
                  <Select
                    ...
                    onValueChange={(val) =>
                      updateSetting('selectedRingtone', val as RingtoneName)
                    }
                  >
                    <SelectTrigger className="flex-1 bg-background/50 border-border/50 h-12 select-none">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                      {RINGTONES.map((name) => (
                        <SelectItem key={name} value={name} className="select-none">
                          {name}
                        </SelectItem>
                      ))}
                    </SelectContent>
                  ...
                  <Button
                    variant="secondary"
                    size="icon"
                    className="h-12 w-12 bg-primary/10 text-primary select-none"
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="text-xl font-bold select-none">System Notifications</h3>
          </div>
          <div className="bg-card/30 p-6 rounded-2xl border border-border/50 space-y-2">
            <ToggleSwitch
